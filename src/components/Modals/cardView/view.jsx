                ...
                <div className={styles.modal_background}>
                    <div className={styles.modal}>
                        ...
                        <div className={styles.descricao_portifolio}>
                            <p className={styles.descricao}>Temos o prazer de compartilhar com vocês uma variação do nosso primeiro recurso gratuito.
                                É um modelo de IA. Tentamos redesenhar uma versão mais minimalista do nosso primeiro projeto.</p>
